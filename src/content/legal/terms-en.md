...
These Terms constitute a legally binding agreement between you and Lawh. We reserve the right to modify these Terms at any time. Continued use of the App after any modifications constitutes your acceptance of the revised Terms.
...
Lawh provides the following services:

- **Audio-Based Verse Identification:** Record or upload audio of Quranic recitations to identify matching verses from the Holy Quran using AI-powered voice recognition and matching algorithms
- **Quran Reader:** Browse and read all 114 surahs (chapters) of the Holy Quran with Arabic text (Uthmani script), transliteration, and English translation
- **Search History:** Access your previously identified verses and search history
- **Verse Sharing:** Share identified verses with others

### 2.2 Service Availability

We strive to maintain continuous service availability but do not guarantee uninterrupted access. The App may be temporarily unavailable due to:
...
Lawh is suitable for users of all ages (5+). Users under 18 years of age (or the age of majority in your jurisdiction) should use the App under parental or guardian supervision.

### 3.2 Account Requirements

The App uses device-based identification rather than traditional user accounts. By using the App, you confirm that:
...
- **Unlimited daily and monthly searches**
- **Ad-free experience**
- All current and future premium features

### 4.3 Subscription Pricing

- **Monthly Plan:** $1.00 USD per month (auto-renewing)
- **Yearly Plan:** $10.00 USD per year (auto-renewing, approximately 17% savings)

Prices may vary by region and are subject to change. Local taxes may apply.

### 4.4 Billing and Payment

- Subscriptions are processed through the Apple App Store (iOS) or Google Play Store (Android)
- Payment will be charged to your App Store or Google Play account upon confirmation of purchase
- Subscriptions automatically renew unless canceled at least 24 hours before the end of the current billing period
- Your account will be charged for renewal within 24 hours prior to the end of the current period

### 4.5 Cancellation and Refunds

- You may cancel your subscription at any time through your device's App Store or Google Play settings
- Cancellation takes effect at the end of the current billing period
- No refunds are provided for partial subscription periods
- Refund requests must be directed to Apple or Google, as applicable, in accordance with their refund policies

### 4.6 Free Trial

If a free trial is offered:
- Trial period details will be clearly displayed before subscription
- You will not be charged during the trial period
- If you do not cancel before the trial ends, your subscription will automatically begin, and you will be charged
...
- Identify Quranic verses for personal, educational, or religious purposes
...
- Circumvent usage limits, subscription requirements, or security measures
- Introduce malware, viruses, or harmful code

**Content Violations:**
- Use the App for any unlawful purpose
- Upload content that infringes intellectual property rights
- Submit audio containing offensive, defamatory, or inappropriate material
- Misrepresent the source or nature of audio submissions

**Commercial Violations:**
- Resell or redistribute the App or its content without authorization
...
The App, including its design, code, features, logos, and trademarks, is owned by Lawh and protected by intellectual property laws. All rights not expressly granted are reserved.

### 6.2 Quranic Content and Tanzil Attribution

The Quranic text displayed in this App is provided by the **Tanzil Project** (https://tanzil.net) and is used under the **Creative Commons Attribution 3.0 License**.

**Copyright Notice:** Quran text © Tanzil.net

The Quranic text is the divine word of Allah. The digital representation, formatting, and accuracy verification of the text is the work of the Tanzil Project. We are grateful for their contribution to making authentic Quranic text freely available.

For updates and more information about the Quranic text, please visit: https://tanzil.net/updates/

Translations and transliterations included in the App may be subject to separate licensing arrangements with their respective providers.
...
Any feedback, suggestions, or ideas you provide regarding the App become our property. We may use such feedback without compensation or attribution to you.
...
By submitting audio recordings to the App, you:
- Grant us the right to process the audio for verse identification
- Confirm you have the right to submit such content
- Understand that audio is processed via third-party services

### 7.2 Feedback Data

When you provide feedback (thumbs up/down, corrections), this data may be used to improve our matching algorithms and service quality.
...
The App integrates with third-party services for functionality including voice recognition, push notifications, subscription management, and advertisement delivery.

### 8.2 Third-Party Terms

Your use of these third-party services is subject to their respective terms and privacy policies. We are not responsible for third-party service availability or practices.
...
- Verse identification will be 100% accurate
...
TO THE MAXIMUM EXTENT PERMITTED BY LAW, IN NO EVENT SHALL LAWH, ITS AFFILIATES, DIRECTORS, EMPLOYEES, OR AGENTS BE LIABLE FOR:
- Indirect, incidental, special, consequential, or punitive damages
- Loss of profits, data, use, goodwill, or other intangible losses
- Damages exceeding the amount you paid to us in the twelve (12) months preceding the claim
...
You agree to indemnify, defend, and hold harmless Lawh, its affiliates, officers, directors, employees, and agents from any claims, liabilities, damages, losses, costs, or expenses (including reasonable attorneys' fees) arising from:
- Your use of the App
...
- Provisions that should survive termination (including indemnification, limitation of liability, and dispute resolution) shall remain in effect
...
These Terms, together with our Privacy Policy, constitute the entire agreement between you and Lawh regarding the App.
...
We shall not be liable for any failure to perform due to causes beyond our reasonable control, including natural disasters, war, terrorism, riots, embargoes, acts of civil or military authorities, fire, floods, accidents, or strikes.
...
We reserve the right to modify these Terms at any time. Changes will be effective upon posting to our website or within the App. Material changes will be communicated through:
...
**By using Lawh, you acknowledge that you have read, understood, and agree to be bound by these Terms of Use.**
